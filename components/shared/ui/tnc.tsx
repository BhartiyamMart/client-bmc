    ...
    <>
      ...
      <section className="bg-gray-100">
        <Container className="mx-auto px-5 py-10 sm:px-6 lg:px-8">
          <h1 className="text-2xl font-bold text-balance text-black sm:text-2xl md:text-3xl">Terms of Use</h1>
        </Container>
      </section>
        ...
        <Container className="mx-auto px-5 sm:px-6 lg:px-8">
          <div className="prose prose-gray max-w-none">
            ...
            <ul className="mt-4 list-disc space-y-2 pl-6 text-base leading-relaxed text-gray-700">
              ...
              <li>
                Misuse, fraudulent activity, or breach of these 'Terms' may result in suspension or termination of your
                account.
              </li>
            </ul>
            ...
            <ul className="mt-4 list-disc space-y-2 pl-6 text-base leading-relaxed text-gray-700">
              <li>All products and services listed are subject to availability.</li>
              <li>Prices, offers, and product descriptions may change without prior notice.</li>
              <li>We reserve the right to limit quantities of certain items purchased.</li>
            </ul>
            ...
            <ul className="mt-4 list-disc space-y-2 pl-6 text-base leading-relaxed text-gray-700">
              ...
              <li>
                Payment methods include credit/debit cards, UPI, net banking, cash on delivery (COD) (where available),
                and other options displayed at checkout.
              </li>
              <li>
            ...
            <ul className="mt-4 list-disc space-y-2 pl-6 text-base leading-relaxed text-gray-700">
              <li>
                We strive to deliver products within the estimated timelines. However, delays may occur due to logistics
                or any unforeseen circumstances.
              </li>
              <li>Shipping charges (if any) will be displayed at checkout.</li>
              <li>Risk of loss passes to you once the product is delivered.</li>
            </ul>

            {/* 6. Returns & Refunds */}
            <h3 className="mt-8 text-lg font-semibold text-gray-900">6. Returns & Refunds:</h3>
            <ul className="mt-4 list-disc space-y-2 pl-6 text-base leading-relaxed text-gray-700">
              <li>Our 'Return & Exchange Policy' governs all returns, replacements, and refunds.</li>
              <li>Products must be returned in original condition, unused, and with tags/packaging intact.</li>
            </ul>
            ...
            <ul className="mt-4 list-disc space-y-2 pl-6 text-base leading-relaxed text-gray-700">
              ...
              <li>Distribute viruses, spam, or harmful content.</li>
              <li>Resell, duplicate, or exploit the Platform for unauthorized purposes.</li>
            </ul>
            ...
            <ul className="mt-4 list-disc space-y-2 pl-6 text-base leading-relaxed text-gray-700">
              <li>
                All content, including logos, designs, text, graphics, and software, is the property of Bhartiyam or its
                licensors.
              </li>
              <li>You may not reproduce, copy, or use our intellectual property without written consent.</li>
            </ul>
            ...
            <ul className="mt-4 list-disc space-y-2 pl-6 text-base leading-relaxed text-gray-700">
              <li>
                Bhartiyam will not be liable for indirect, incidental, or consequential damages arising out of your use
                of the Platform.
              </li>
              <li>Our total liability shall not exceed the value of the product purchased.</li>
            </ul>
            ...
            <ul className="mt-4 list-disc space-y-2 pl-6 text-base leading-relaxed text-gray-700">
              <li>These Terms are as per the laws of India.</li>
              <li>
