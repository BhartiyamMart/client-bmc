...
import WalletDetails from '../pages/account/wallet/wallet';
            ...
            <div className="rounded border-2 border-gray-200 bg-white p-4">
              <div className="flex items-start gap-3">
                <label htmlFor="terms-agreement" className="relative flex cursor-pointer items-center">
                  ...
                  />
                  <div className="peer-checked:border-primary peer-checked:bg-primary peer h-5 w-5 cursor-pointer rounded border-2 border-gray-300 bg-white transition-all peer-disabled:cursor-not-allowed peer-disabled:opacity-50">
